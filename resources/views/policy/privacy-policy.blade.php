                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('privacy-policy.update') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label style="font-size: 18px;" for="passenger_message">Passenger Privacy Policy Content</label>
                            <textarea class="form-control" id="passenger_message" name="passenger_message" rows="10">{{ $data->passenger_message ?? '' }}</textarea>
                        </div>
                        <div class="form-group">
                            <label style="font-size: 18px;" for="driver_message">Rider Privacy Policy Content</label>
