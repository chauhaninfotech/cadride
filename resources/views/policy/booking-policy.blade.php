<x-app-layout>
    <x-slot name="header">
        <div class="page-header" style="margin-bottom: 0px; padding: 15px 0px;">
              <h3 class="page-title">
                 <i class="fa fa-shield"></i> Booking Policy
              </h3>
        ...
        <div class="col-md-12 stretch-card grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('booking-policy.update') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label style="font-size: 18px;" for="passenger_message">Passenger Booking Policy Content</label>
                            <textarea class="form-control" id="passenger_message" name="passenger_message" rows="10">{{ $data->passenger_message ?? '' }}</textarea>
                        </div>
                        <div class="form-group">
                            <label style="font-size: 18px;" for="driver_message">Rider Booking Policy Content</label>
