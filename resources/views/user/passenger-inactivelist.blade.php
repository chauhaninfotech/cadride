                      ...
                      <div class="row">
                       ...
                       <div class="col-md-2" >
                        ...
                        <div class="col-md-3" style="padding: 0px;">
                          ...
                          <a href="{{ url('passenger-inactivelist') }}" style="padding: 14px 20px;" class="btn btn-secondary">Reset</a>
                        </div>
                      </div>
                    </form>
                        ...
                        <tbody>
                          @forelse($passengers as $key => $passenger)
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="{{ route('passenger.edit', ['id' => $passenger->id]) }}" title="Edit"><i class="fa fa-pencil"></i> </a>
