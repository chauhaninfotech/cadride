                      ...
                      <div class="row">
                       ...
                       <div class="col-md-2" >
                        ...
                        <div class="col-md-3" style="padding: 0px;">
                          ...
                          <a href="{{ url('passenger-pendinglist') }}" style="padding: 14px 20px;" class="btn btn-secondary">Reset</a>
                        </div>
                      </div>
                    </form>
                        ...
                        <tbody>
                          @forelse($passengers as $key => $passenger)
                            <tr>
                                ...
                                <td class="select"><input type="checkbox" class="passengerCheck" data-id="{{ $passenger->id }}" /></td>
                                ...
                                <td class="actions">
                                    ...
                                    <br><a href="{{ route('passenger.show', ['id' => $passenger->id]) }}" ><i class="fa fa-eye"></i> </a>
